define(["comp/common/collapse",
    ...
    var handleTrain = function(){
        console.log("strat para entrenar el conjunto de datos~");
        var para = {};
        para.type = modelType;
            ...
            if ( data.result === "Success") {
                ...
                $.get(trainUrl, trainPara, function( tdata ) {
                    if (tdata.result === "Success" ) {
                        ...
                        alert("Error al entrenar el modelo : " + modelType);
                    }
                });

            } else {
                alert("Error al crear el modelo : " + modelType);
            }
        });
    };
                ...
                if (ready) {
                    ...
                    $.get(predictUrl, para, function( pdata ) {
                        if (pdata.result === "Success" ) {
                            ...
                            alert("No se pudo predecir el resultado!");
                        }
                    });
                }
            })
                ...
                <div className="row">
                    <div className="col-md-4">
                        <div className="panel-group" role="tablist" aria-multiselectable="true">
                            ...
                            <Collapse title="Seleccione el modelo" id="SelectModelCollapse">
                                <select className="input-medium" id="selectModelType"/>
                            </Collapse>

                            <Collapse title="Seleccione los datos" id="SelectDataCollapse">
                            ...
                            <Collapse title="Modelo de entrenamiento" id="TrainCollapse">
                                <div>
